...
const Navbar = () => {
    ...
    return (
        <div className="header">
            ...
            <div className="logo">
            <Link to="hero" spy={true} smooth={true} offset={-105} duration={500} onClick={() => handleItemClick('hero')}>
              <img src={Logo} alt="Logo" />
                ...
                " spy={true} smooth={true} offset={-55} duration={500} onClick={closeMenu} className="nav-item" >Home</Link>
                    ...
                    <li className="nav-item"><Link to="process
                " spy={true} smooth={true} offset={-55} duration={500} className="nav-item" onClick={closeMenu}>How it Works</Link>
                    </li>
                ...
                " spy={true} smooth={true} offset={-55} duration={500} className="nav-item" onClick={closeMenu}>Services</Link>
                    ...
                    <li className="nav-item"><Link to="products
                " spy={true} smooth={true} offset={-55} duration={500} className="nav-item" onClick={closeMenu}>Products</Link>
                    </li>
